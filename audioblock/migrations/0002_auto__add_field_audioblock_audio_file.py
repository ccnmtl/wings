...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AudioBlock.audio_file'
        db.add_column('audioblock_audioblock', 'audio_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AudioBlock.audio_file'
        db.delete_column('audioblock_audioblock', 'audio_file')


    models = {
        'audioblock.audioblock': {
            'Meta': {'object_name': 'AudioBlock'},
