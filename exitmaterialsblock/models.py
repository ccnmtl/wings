...
class ExitMaterialsBlock(models.Model):
    ...
    display_name = "Exit Materials Block"
    ...
    def create(self,request):
        return ExitMaterialsBlock.objects.create(description=request.POST.get('description', ''))
