...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HelpBlock.audio_file'
        db.add_column('helpblock_helpblock', 'audio_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HelpBlock.audio_file'
        db.delete_column('helpblock_helpblock', 'audio_file')
