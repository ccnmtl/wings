...
bot.locators.xpath.isCausedByInvalidXPath_ = function(a) {
  return"NS_ERROR_ILLEGAL_VALUE" != a.name
};
bot.locators.xpath.single = function(a, b) {
  var c = function(b, c) {
    ...
    try {
      ...
      if(bot.locators.xpath.isCausedByInvalidXPath_(h)) {
...
bot.Device.prototype.fireMouseEvent = function(a, b, c, d) {
  ...
  b = {clientX:b.x, clientY:b.y, button:c, altKey:!1, ctrlKey:!1, shiftKey:!1, metaKey:!1, relatedTarget:d || null};
...
bot.Device.EXPLICIT_FOLLOW_LINK_ = goog.userAgent.IE || goog.userAgent.GECKO && !bot.isFirefoxExtension() || goog.userAgent.GECKO && bot.isFirefoxExtension() && !bot.userAgent.isVersion(4);
bot.Device.CAN_SYNTHESISED_EVENTS_FOLLOW_LINKS_ = goog.userAgent.GECKO && bot.isFirefoxExtension() && bot.userAgent.isVersion(4);
bot.Device.SYNTHESISED_EVENTS_CAN_OPEN_JAVASCRIPT_WINDOWS_ = goog.userAgent.GECKO && bot.isFirefoxExtension();
...
bot.Device.followHref_ = function(a) {
  ...
  goog.userAgent.IE && !goog.userAgent.isVersion(8) && (b = bot.Device.resolveUrl_(c.location, b));
...
bot.events.EventFactory_.prototype.create = function(a) {
  ...
  bot.events.IE_NO_W3C_EVENTS_ ? a = a.createEventObject() : (a = a.createEvent("HTMLEvents"), a.initEvent(this.type_, this.bubbles_, this.cancelable_));
  return a
};
...
bot.events.MouseEventFactory_.prototype.create = function(a, b) {
  ...
  if(bot.events.IE_NO_W3C_EVENTS_) {
    c = c.createEventObject(), c.altKey = b.altKey, c.ctrlKey = b.ctrlKey, c.metaKey = b.metaKey, c.shiftKey = b.shiftKey, c.button = b.button, c.clientX = b.clientX, c.clientY = b.clientY, this == bot.events.EventType.MOUSEOUT ? (c.fromElement = a, c.toElement = b.relatedTarget) : this == bot.events.EventType.MOUSEOVER ? (c.fromElement = b.relatedTarget, c.toElement = a) : (c.fromElement = null, c.toElement = null)
  }else {
    var d = goog.dom.getWindow(c), c = c.createEvent("MouseEvents");
    c.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, d, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, b.button, b.relatedTarget)
  }
  return c
};
...
bot.events.KeyboardEventFactory_.prototype.create = function(a, b) {
  ...
  if(goog.userAgent.GECKO) {
    ...
    if(bot.events.IE_NO_W3C_EVENTS_ ? c = c.createEventObject() : (c = c.createEvent("Events"), c.initEvent(this.type_, this.bubbles_, this.cancelable_)), c.altKey = b.altKey, c.ctrlKey = b.ctrlKey, c.metaKey = b.metaKey, c.shiftKey = b.shiftKey, c.keyCode = b.charCode || b.keyCode, goog.userAgent.WEBKIT) {
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  if(goog.userAgent.IE) {
    throw new bot.Error(bot.ErrorCode.UNSUPPORTED_OPERATION, "IE does not support firing touch events.");
  }
...
!0, !0), CONTEXTMENU:new bot.events.MouseEventFactory_("contextmenu", !0, !0), DBLCLICK:new bot.events.MouseEventFactory_("dblclick", !0, !0), MOUSEDOWN:new bot.events.MouseEventFactory_("mousedown", !0, !0), MOUSEMOVE:new bot.events.MouseEventFactory_("mousemove", !0, !1), MOUSEOUT:new bot.events.MouseEventFactory_("mouseout", !0, !0), MOUSEOVER:new bot.events.MouseEventFactory_("mouseover", !0, !0), MOUSEUP:new bot.events.MouseEventFactory_("mouseup", !0, !0), KEYDOWN:new bot.events.KeyboardEventFactory_("keydown", 
!0, !0), KEYPRESS:new bot.events.KeyboardEventFactory_("keypress", !0, !0), KEYUP:new bot.events.KeyboardEventFactory_("keyup", !0, !0), TOUCHEND:new bot.events.TouchEventFactory_("touchend", !0, !0), TOUCHMOVE:new bot.events.TouchEventFactory_("touchmove", !0, !0), TOUCHSTART:new bot.events.TouchEventFactory_("touchstart", !0, !0)};
bot.events.fire = function(a, b, c) {
  c = b.create(a, c);
  if(!("isTrusted" in c)) {
    c.isTrusted = !1
  }
  return bot.events.IE_NO_W3C_EVENTS_ ? a.fireEvent("on" + b.type_, c) : a.dispatchEvent(c)
};
bot.events.isSynthetic = function(a) {
  a = a.getBrowserEvent ? a.getBrowserEvent() : a;
  return"isTrusted" in a ? !a.isTrusted : !1
};
bot.events.IE_NO_W3C_EVENTS_ = goog.userAgent.IE && (!goog.userAgent.isVersion(9) || !document.dispatchEvent);
goog.dom.selection = {};
...
bot.Mouse.MOUSE_BUTTON_VALUE_MAP_ = function() {
  var a = {};
  goog.userAgent.IE ? (a[bot.events.EventType.CLICK] = [0, 0, 0, null], a[bot.events.EventType.CONTEXTMENU] = [null, null, 0, null], a[bot.events.EventType.MOUSEUP] = [1, 4, 2, null], a[bot.events.EventType.MOUSEOUT] = [0, 0, 0, 0], a[bot.events.EventType.MOUSEMOVE] = [1, 4, 2, 0]) : goog.userAgent.WEBKIT ? (a[bot.events.EventType.CLICK] = [0, 1, 2, null], a[bot.events.EventType.CONTEXTMENU] = [null, null, 2, null], a[bot.events.EventType.MOUSEUP] = [0, 1, 2, null], a[bot.events.EventType.MOUSEOUT] = 
  [0, 1, 2, 0], a[bot.events.EventType.MOUSEMOVE] = [0, 1, 2, 0]) : (a[bot.events.EventType.CLICK] = [0, 1, 2, null], a[bot.events.EventType.CONTEXTMENU] = [null, null, 2, null], a[bot.events.EventType.MOUSEUP] = [0, 1, 2, null], a[bot.events.EventType.MOUSEOUT] = [0, 0, 0, 0], a[bot.events.EventType.MOUSEMOVE] = [0, 0, 0, 0]);
...
bot.Mouse.prototype.fireMousedown_ = function() {
  var a = goog.userAgent.GECKO && !bot.userAgent.isVersion(4);
...
bot.action.scrollIntoView = function(a, b) {
  bot.dom.isScrolledIntoView(a, b) || a.scrollIntoView();
  var c = bot.dom.isScrolledIntoView(a, b);
  if(!c && b) {
...
bot.html5.IS_SAFARI5_WINDOWS_ = goog.userAgent.WINDOWS && goog.userAgent.SAFARI && bot.userAgent.isVersion(5) && !bot.userAgent.isVersion(6);
...
webdriver.atoms.inject.getWindow_ = function(a) {
  return a ? bot.inject.cache.getElement(a.WINDOW) : window
};
...
core.events.replaceText_ = function(a, b) {
  ...
  try {
    d = a, Components && Components.classes && XPCNativeWrapper && (d = new XPCNativeWrapper(a)), bot.events.fire(d, bot.events.EventType.CHANGE)
  }catch(e) {
  }
};
