...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExitMaterialsBlock'
        db.create_table('exitmaterialsblock_exitmaterialsblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('exitmaterialsblock', ['ExitMaterialsBlock'])


    def backwards(self, orm):
        
        # Deleting model 'ExitMaterialsBlock'
        db.delete_table('exitmaterialsblock_exitmaterialsblock')
    ...
    models = {
        ...
        'exitmaterialsblock.exitmaterialsblock': {
            'Meta': {'object_name': 'ExitMaterialsBlock'},
    ...
    complete_apps = ['exitmaterialsblock']
