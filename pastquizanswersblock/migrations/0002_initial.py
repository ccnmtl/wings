...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PastQuizAnswersBlock'
        db.create_table('pastquizanswersblock_pastquizanswersblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('copy', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('pastquizanswersblock', ['PastQuizAnswersBlock'])


    def backwards(self, orm):
        
        # Deleting model 'PastQuizAnswersBlock'
        db.delete_table('pastquizanswersblock_pastquizanswersblock')
    ...
    models = {
        ...
        'pastquizanswersblock.pastquizanswersblock': {
            'Meta': {'object_name': 'PastQuizAnswersBlock'},
    ...
    complete_apps = ['pastquizanswersblock']
