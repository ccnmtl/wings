...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NarrowedDownAnswer'
        db.create_table('servicesblock_narroweddownanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizblock.Answer'])),
        ))
        db.send_create_signal('servicesblock', ['NarrowedDownAnswer'])


    def backwards(self, orm):
        
        # Deleting model 'NarrowedDownAnswer'
        db.delete_table('servicesblock_narroweddownanswer')
