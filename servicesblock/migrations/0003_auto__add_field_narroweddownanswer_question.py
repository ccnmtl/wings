...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NarrowedDownAnswer.question'
        db.add_column('servicesblock_narroweddownanswer', 'question', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['quizblock.Question']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NarrowedDownAnswer.question'
        db.delete_column('servicesblock_narroweddownanswer', 'question_id')
    ...
    models = {
        ...
        'servicesblock.narroweddownanswer': {
            ...
            'answer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['quizblock.Answer']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
