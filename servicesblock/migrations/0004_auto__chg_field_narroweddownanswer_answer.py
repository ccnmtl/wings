...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NarrowedDownAnswer.answer'
        db.alter_column('servicesblock_narroweddownanswer', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizblock.Answer'], null=True))


    def backwards(self, orm):
        
        # Changing field 'NarrowedDownAnswer.answer'
        db.alter_column('servicesblock_narroweddownanswer', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['quizblock.Answer']))
