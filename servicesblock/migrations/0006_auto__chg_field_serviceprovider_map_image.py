...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceProvider.map_image'
        db.alter_column('servicesblock_serviceprovider', 'map_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'ServiceProvider.map_image'
        db.alter_column('servicesblock_serviceprovider', 'map_image', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))
