...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServicesBlock.page_type'
        db.add_column('servicesblock_servicesblock', 'page_type', self.gf('django.db.models.fields.TextField')(default='page_1'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ServicesBlock.page_type'
        db.delete_column('servicesblock_servicesblock', 'page_type')
