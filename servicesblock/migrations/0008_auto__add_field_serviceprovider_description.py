...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('servicesblock_serviceprovider', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ServiceProvider.description'
        db.delete_column('servicesblock_serviceprovider', 'description')
