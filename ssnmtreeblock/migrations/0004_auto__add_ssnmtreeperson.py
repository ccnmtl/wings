...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SsnmTreePerson'
        db.create_table('ssnmtreeblock_ssnmtreeperson', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('tree_box', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ssnmtreeblock.SsnmTreeBox'])),
        ))
        db.send_create_signal('ssnmtreeblock', ['SsnmTreePerson'])


    def backwards(self, orm):
        
        # Deleting model 'SsnmTreePerson'
        db.delete_table('ssnmtreeblock_ssnmtreeperson')
