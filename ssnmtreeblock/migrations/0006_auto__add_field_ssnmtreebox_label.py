...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SsnmTreeBox.label'
        db.add_column('ssnmtreeblock_ssnmtreebox', 'label', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SsnmTreeBox.label'
        db.delete_column('ssnmtreeblock_ssnmtreebox', 'label')
