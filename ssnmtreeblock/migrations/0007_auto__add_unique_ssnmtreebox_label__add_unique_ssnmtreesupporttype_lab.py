...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SsnmTreeBox', fields ['label']
        db.create_unique('ssnmtreeblock_ssnmtreebox', ['label'])

        # Adding unique constraint on 'SsnmTreeSupportType', fields ['label']
        db.create_unique('ssnmtreeblock_ssnmtreesupporttype', ['label'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SsnmTreeSupportType', fields ['label']
        db.delete_unique('ssnmtreeblock_ssnmtreesupporttype', ['label'])

        # Removing unique constraint on 'SsnmTreeBox', fields ['label']
        db.delete_unique('ssnmtreeblock_ssnmtreebox', ['label'])
