...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.numeric_value'
        db.add_column('quizblock_answer', 'numeric_value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Answer.numeric_value'
        db.delete_column('quizblock_answer', 'numeric_value')
    ...
    models = {
        ...
        'quizblock.answer': {
            ...
            'numeric_value': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
