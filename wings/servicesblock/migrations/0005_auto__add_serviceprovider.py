...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('servicesblock_serviceprovider', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizblock.Answer'], null=True)),
            ...
            ('map_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('servicesblock', ['ServiceProvider'])


    def backwards(self, orm):
        
        # Deleting model 'ServiceProvider'
        db.delete_table('servicesblock_serviceprovider')
    ...
    models = {
        ...
        'servicesblock.narroweddownanswer': {
            'Meta': {'object_name': 'NarrowedDownAnswer'},
            'answer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['quizblock.Answer']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['quizblock.Question']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'servicesblock.serviceprovider': {
            'Meta': {'object_name': 'ServiceProvider'},
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['quizblock.Answer']", 'null': 'True'}),
            'map_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
