...
psql eddie -d wings -c "update pagetree_hierarchy set name = 'localhost:12345';"
psql eddie -d wings -c "update main_stand set hostname = 'localhost:12345' where title='wings';"
