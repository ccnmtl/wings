...
dropdb wings_marc
createdb -O pusher  wings_marc
psql pusher -d wings_marc -f ./wings.sql
psql pusher -d wings_marc -c "update pagetree_hierarchy set name = 'kang.ccnmtl.columbia.edu:13074';"
psql pusher -d wings_marc -c "update main_stand set hostname = 'kang.ccnmtl.columbia.edu:13074' where title='wings_marc';"
